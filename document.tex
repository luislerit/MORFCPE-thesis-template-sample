...
\defineAuthor{surname1}{Lerit}
\defineAuthor{firstname1}{Jose Mari Luis L.}
...
\defineAuthor{surname4}{Chan}
\defineAuthor{firstname4}{Zion}

\defineAuthor{surname5}{Garcia}
\defineAuthor{firstname5}{Laureen Audrey}

\newcommand{\documentTitle}{Microcontroller based anti collision monitoring system for vehicles} % put tilde (~) between words to indicate non-breaking adjacent words
